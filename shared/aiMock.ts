...
export function buildMockSuggestions(csvColumns: string[], captions: string[]): Array<{ csvColumn: string; targetCaption: string; confidence: number }> {
...
export function buildMockChatContent(params: { fileColumns: string[]; captions: string[]; mappings: Array<{ csvColumn: string; targetCaption: string; confidence: number }>; message?: string; provider: string; model: string; }): string {
...
export function generateMockResponse(req: AIRequest): AIResponse {
